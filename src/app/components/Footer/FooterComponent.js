...
export default function FooterComponent() {
  return (
    <footer className="footer flex justify-center gap-40 p-10 bg-dark-blue text-white">
      <aside>
      ...
      <nav>
        ...
        <ul className="px-1">
          <Link href="/course"><li><a className="link link-hover">Course</a></li></Link>
          <Link href="/itNews"><li><a className="link link-hover">IT News</a></li></Link>
          <Link href="/jobOpportunity"><li><a className="link link-hover">Job Opportunity</a></li></Link>
